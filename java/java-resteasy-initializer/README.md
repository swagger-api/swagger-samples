...
This sample is based on RESTEasy, and provides an example of integration of swagger into a RESTEasy based app, with resources to be scanned provided by `swagger-jaxrs2-servlet-initializer` (`ServletContainerInitializer` implementation)
