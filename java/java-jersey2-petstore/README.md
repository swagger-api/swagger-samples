...
This sample is based on jersey2, and provides an example of integration of swagger into a jersey2 based app, with config file based configuration/initialization
...
### Testing the server
Once started, you can navigate to http://localhost:8002/petstore/openapi.json to view the Swagger Resource Listing.
