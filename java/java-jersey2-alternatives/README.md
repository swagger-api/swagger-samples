...
This sample is based on jersey2, and provides an example of alternative mechanims (in comments in web.xml and Application)
 to integrate swagger into a jersey2 based app. Siblings jersey samples modules focus on a given integration scenario.
