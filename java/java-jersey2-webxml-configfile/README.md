...
This sample is based on jersey2, and provides an example of integration of swagger into a jersey2 based app, with custom config file location provided as `web.xml initParam`.
