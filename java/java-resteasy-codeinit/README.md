...
This sample is based on RESTEasy, and provides an example of integration of swagger into a RESTEasy based app, with code based configuration/initialization.
