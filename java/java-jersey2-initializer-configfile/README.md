...
This sample is based on jersey2, and provides an example of integration of swagger into a jersey2 based app, with resources to be scanned provided by `swagger-jaxrs2-servlet-initializer` (`ServletContainerInitializer` implementation), with config file based configuration. 
