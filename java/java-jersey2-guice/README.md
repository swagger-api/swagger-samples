...
This sample is based on jersey2, and provides an example of integration of swagger into a jersey2/guice based app, with code based configuration/initialization
