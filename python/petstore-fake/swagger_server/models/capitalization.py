...
class Capitalization(Model):
    ...
    """
    def __init__(self, small_camel: str=None, capital_camel: str=None, small_snake: str=None, capital_snake: str=None, sca_eth_flow_points: str=None, att_name: str=None):  # noqa: E501
    ...
    @small_camel.setter
    def small_camel(self, small_camel: str):
    ...
    def capital_camel(self, capital_camel: str):
    ...
    @small_snake.setter
    def small_snake(self, small_snake: str):
    ...
    def capital_snake(self, capital_snake: str):
    ...
    def sca_eth_flow_points(self, sca_eth_flow_points: str):
    ...
    @att_name.setter
    def att_name(self, att_name: str):
