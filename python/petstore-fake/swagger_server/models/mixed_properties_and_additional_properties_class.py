...
class MixedPropertiesAndAdditionalPropertiesClass(Model):
    ...
    """
    def __init__(self, uuid: str=None, date_time: datetime=None, map: Dict[str, Animal]=None):  # noqa: E501
    ...
    @map.setter
    def map(self, map: Dict[str, Animal]):
