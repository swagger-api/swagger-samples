...
class Name(Model):
    ...
    """
    def __init__(self, name: int=None, snake_case: int=None, _property: str=None, _123_number: int=None):  # noqa: E501
    ...
    @snake_case.setter
    def snake_case(self, snake_case: int):
    ...
    @_123_number.setter
    def _123_number(self, _123_number: int):
