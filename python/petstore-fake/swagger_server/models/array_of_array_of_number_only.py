...
class ArrayOfArrayOfNumberOnly(Model):
    ...
    """
    def __init__(self, array_array_number: List[List[float]]=None):  # noqa: E501
    ...
    @property
    def array_array_number(self) -> List[List[float]]:
    ...
    def array_array_number(self, array_array_number: List[List[float]]):
